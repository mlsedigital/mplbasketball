...
class Court():
    ...
    Attributes:
        court_type (str): Type of the court, either 'nba' or 'wnba'.
    ...
    Raises:
        AssertionError: If the provided court_type is not 'nba' or 'wnba'.
    """
    ...
    def draw(self,
        ...
        assert orientation in ["v", "h", "hl", "hr", "vu", "vd"], "Invalid orientation. Choose 'horizontal' or 'vertical'"
    ...
    def _draw_horizontal_court(self, ax, half,
        ...
        self._draw_rectangle(ax, origin_shift_x-court_x/2-cf, origin_shift_y-court_y/2-cf,
        ...
        if half is None or half == "l":
            print(half)
            self._draw_rectangle(ax, origin_shift_x-court_x/2-cf, origin_shift_y-outer_paint_y/2-cf,
        ...
        if half is None or half == "r":
            self._draw_rectangle(ax, origin_shift_x+court_x/2-outer_paint_x-cf, origin_shift_y-outer_paint_y/2-cf,
                                 outer_paint_x+2*cf, outer_paint_y+2*cf,
                                 line_width=line_width,
                                 line_color=line_color,
                                 line_style="-",
        ...
        # Left side
        if half is None or half == "l":
            self._draw_rectangle(ax, origin_shift_x-court_x/2-cf, origin_shift_y-inner_paint_y/2-cf,
        ...
        # Right side
        if half is None or half == "r":
            self._draw_rectangle(ax, origin_shift_x+court_x/2-inner_paint_x-cf, origin_shift_y-inner_paint_y/2-cf,
                                 inner_paint_x+2*cf, inner_paint_y+2*cf,
                                 line_width=line_width,
                                 line_color=line_color,
                                 line_style="-",
        ...
        # Left side
        if half is None or half == "l":
            self._draw_circle(ax, left_hoop_x, origin_shift_y,
        ...
        # Right side
        if half is None or half == "r":
            self._draw_circle(ax, right_hoop_x, origin_shift_y,
                              self.court_parameters["hoop_diameter"],
                              line_width=line_width,
                              line_color=line_color,
                              line_style="-",
        ...
        if half is None or half == "l":
            self._draw_line(ax,
                            origin_shift_x-court_x/2+bb_distance, origin_shift_y-bb_width/2,
                            0., bb_width,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        # Left side
        if half is None or half == "l":
            self._draw_circular_arc(ax, left_hoop_x, origin_shift_y,
                                    charge_diameter+cf,
        ...
        # Right side
        if half is None or half == "r":
            self._draw_circular_arc(ax, right_hoop_x, origin_shift_y,
                                    charge_diameter+cf,
                                    angle=0, theta1=90, theta2=-90,
                                    line_width=line_width,
                                    line_color=line_color,
        ...
        # Left-upper
        if half is None or half == "l":
            self._draw_circular_arc(ax, origin_shift_x-court_x/2+inner_paint_x+cf, origin_shift_y,
                                    inner_paint_y+2*cf,
                                    angle=0, theta1=-90, theta2=90,
                                    line_width=line_width,
                                    line_color=line_color,
        ...
        if half is None or half == "l":
            self._draw_line(ax,
                            origin_shift_x-court_x/2+ib_line_distance+cf, origin_shift_y+court_y/2,
                            0., -ib_line_length+cf,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
            ...
            self._draw_line(ax,
                            ...
                            alpha=line_alpha)
            self._draw_line(ax,
                            origin_shift_x-ob_line_distance, origin_shift_y+court_y/2+cf,
                            0., ob_line_length-cf,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        if half is None or half == "l":
            self._draw_line(ax,
                            origin_shift_x-court_x/2, origin_shift_y+court_y/2-side_width_3pt-cf,
                            line_length_3pt, 0.,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        if half is None or half == "r":
            # Right-upper side
            self._draw_line(ax,
                            origin_shift_x+court_x/2-line_length_3pt, origin_shift_y+court_y/2-side_width_3pt-cf,
                            line_length_3pt, 0.,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        # Draw center line
        self._draw_line(ax,
                        origin_shift_x, origin_shift_y-court_y/2,
                        0., court_y,
                        line_width=line_width,
                        line_color=line_color,
                        line_style="-",
        ...
        # Outer circle
        self._draw_circle(ax, origin_shift_x, origin_shift_y,
    ...
    def _draw_vertical_court(self, ax, half,
        ...
        # Draw the main court rectangle
        self._draw_rectangle(ax, origin_shift_y-court_y/2-cf, origin_shift_x-court_x/2-cf,
        ...
        if half is None or half == "d":
            self._draw_rectangle(ax, origin_shift_y-outer_paint_y/2-cf, origin_shift_x-court_x/2-cf,
        ...
        if half is None or half == "u":
            self._draw_rectangle(ax, origin_shift_y-outer_paint_y/2-cf, origin_shift_x+court_x/2-outer_paint_x-cf,
                                 outer_paint_y+2*cf, outer_paint_x+2*cf,
                                 line_width=line_width,
                                 line_color=line_color,
                                 line_style="-",
        ...
        # Left side
        if half is None or half == "d":
            self._draw_rectangle(ax, origin_shift_y-inner_paint_y/2-cf, origin_shift_x-court_x/2-cf,
        ...
        # Right side
        if half is None or half == "u":
            self._draw_rectangle(ax, origin_shift_y-inner_paint_y/2-cf, origin_shift_x+court_x/2-inner_paint_x-cf,
                                 inner_paint_y+2*cf, inner_paint_x+2*cf,
                                 line_width=line_width,
                                 line_color=line_color,
                                 line_style="-",
        ...
        # Left side
        if half is None or half == "d":
            self._draw_circle(ax, origin_shift_y, left_hoop_x,
                              self.court_parameters["hoop_diameter"],
                              line_width=line_width,
                              line_color=line_color,
                              line_style="-",
        ...
        # Right side
        if half is None or half == "u":
            self._draw_circle(ax, origin_shift_y, right_hoop_x,
                              self.court_parameters["hoop_diameter"],
                              line_width=line_width,
                              line_color=line_color,
                              line_style="-",
        ...
        if half is None or half == "d":
            self._draw_line(ax,
                            origin_shift_y-bb_width/2, origin_shift_x-court_x/2+bb_distance,
                            bb_width, 0.,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        # Left side
        if half is None or half == "d":
            self._draw_circular_arc(ax, origin_shift_y, left_hoop_x,
                                    charge_diameter+cf,
        ...
        # Right side
        if half is None or half == "u":
            self._draw_circular_arc(ax, origin_shift_y, right_hoop_x,
                                    charge_diameter+cf,
        ...
        # Left-upper
        if half is None or half == "d":
            self._draw_circular_arc(ax, origin_shift_y, origin_shift_x-court_x/2+inner_paint_x+cf,
                                    inner_paint_y+2*cf,
                                    angle=0, theta1=0, theta2=180,
                                    line_width=line_width,
                                    line_color=line_color,
        ...
        ib_line_distance = self.court_parameters["inbound_line_distance_from_edge"]
        ib_line_length = self.court_parameters["inbound_line_length"]
        ob_line_distance = 4+1/12 # self.court_parameters["outbound_line_distance_from_center"]
        ob_line_length = 4. # self.court_parameters["outbound_line_length"]
        # Left side
        if half is None or half == "d":
            self._draw_line(ax,
                            origin_shift_y+court_y/2, origin_shift_x-court_x/2+ib_line_distance+cf,
                            -ib_line_length+cf, 0., 
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
            ...
            self._draw_line(ax,
                            ...
                            alpha=line_alpha)
            self._draw_line(ax,
                            origin_shift_y-court_y/2-cf, origin_shift_x-ob_line_distance,
                            -ob_line_length+cf, 0.,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        if half is None or half == "d":
            # Left-upper side
            self._draw_line(ax,
                            origin_shift_y+court_y/2-side_width_3pt-cf, origin_shift_x-court_x/2,
                            0., line_length_3pt,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        if half is None or half == "u":
            # Right-upper side
            self._draw_line(ax,
                            origin_shift_y+court_y/2-side_width_3pt-cf, origin_shift_x+court_x/2-line_length_3pt,
                            0., line_length_3pt,
                            line_width=line_width,
                            line_color=line_color,
                            line_style="-",
        ...
        # Draw center line
        self._draw_line(ax,
                        origin_shift_y-court_y/2, origin_shift_x,
                        court_y, 0.,
                        line_width=line_width,
                        line_color=line_color,
                        line_style="-",
        ...
        # Outer circle
        self._draw_circle(ax, origin_shift_y, origin_shift_x,
                          self.court_parameters["outer_circle_diameter"],
                          line_width=line_width,
                          line_color=line_color,
                          line_style="-",
