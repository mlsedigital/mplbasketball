# Description: This script demonstrates how to plot multiple basketball shots on a single plot using the mplbasketball package.

import numpy as np
import matplotlib.pyplot as plt
from mplbasketball.court import Court

player_names = ["Fred Van Vleet", "Scottie Barnes", "OG Anunoby", "Pascal Siakam"]
